...
import net.balqisstudio.goeksdriver.activity.DestinasiMboxActivity;
import net.balqisstudio.goeksdriver.activity.DetailPengirimanActivity;
import net.balqisstudio.goeksdriver.activity.KonfirmasiBarangActivity;
import net.balqisstudio.goeksdriver.activity.ListBarangActivity;
import net.balqisstudio.goeksdriver.activity.ListMakananActivity;
import net.balqisstudio.goeksdriver.model.DestinasiMbox;
import net.balqisstudio.goeksdriver.network.AsyncTaskHelperNoLoad;
...
import net.balqisstudio.goeksdriver.activity.ChatActivity;
import net.balqisstudio.goeksdriver.activity.RatingUserActivity;
import net.balqisstudio.goeksdriver.database.DBHandler;
import net.balqisstudio.goeksdriver.database.Queries;
import net.balqisstudio.goeksdriver.gmaps.GMapDirection;
import net.balqisstudio.goeksdriver.gmaps.directions.Directions;
import net.balqisstudio.goeksdriver.gmaps.directions.Leg;
import net.balqisstudio.goeksdriver.gmaps.directions.Route;
import net.balqisstudio.goeksdriver.gmaps.directions.Step;
...
//        myTrans = (Transaksi) receiver.getSerializable("data_order");
        switch (Integer.parseInt(myTrans.order_fitur)){
            case 1: {
                ...
                pickUpPelanggan = (TextView) rootView.findViewById(R.id.pickUpPelanggan);
                break;
            }
            case 2: {
                rootView = inflater.inflate(R.layout.content_order_mride, container, false);
            ...
            case 6:{
                ...
                problem.setText(myTrans.lama_pelayanan+" minute");
            ...
            case 7:{
                ...
                shpper.setText(String.valueOf(myTrans.shipper)+" Helper");
                namaBarang = (TextView) rootView.findViewById(R.id.namaBarang);
                namaBarang.setText(myTrans.nama_barang);
                listBarang = (TextView) rootView.findViewById(R.id.listBarang);
                listBarang.setText("Destination Detail");
                listBarang.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
    ...
    private void initView() {
        ...
        final TextView callPelanggan;
        final TextView chatPelanggan;
        ...
        chatPelanggan = (TextView) rootView.findViewById(R.id.chatPelanggan);
        callPelanggan = (TextView) rootView.findViewById(R.id.callPelanggan);
//        cancelOrder = (ImageView) rootView.findViewById(R.id.cancelOrder);
        ...
        if(driver.status == 2){
            ...
            if(myTrans.order_fitur.equals("4") || myTrans.order_fitur.equals("3")){
                textStatus.setText("Status : order purchase");
            }else if(myTrans.order_fitur.equals("5")){
                textStatus.setText("Status : Take Order");
            }else if(myTrans.order_fitur.equals("7")){
                textStatus.setText("Status : Take Order");
            }else if(myTrans.order_fitur.equals("6") || myTrans.order_fitur.equals("8")){
                textStatus.setText("Status : To the location");
            }else{
                textStatus.setText("Status : Towards pick-up");
            }
        }

        if(driver.status == 3){
            pickUpPelanggan.setText("Finish");
            if(myTrans.order_fitur.equals("4") || myTrans.order_fitur.equals("3")){
                textStatus.setText("Status : order purchase");
            }else if(myTrans.order_fitur.equals("5")){
                textStatus.setText("Status : Take Order");
                ...
                textStatus.setText("Status : Run service");
            }else{
                textStatus.setText("Status : Customer delivery");
            }
        }
            ...
            public void onSuccess(JSONObject obj) {
                try {
                    if(obj.getString("message").equals("success")){
                        ...
                        Toast.makeText(activity, "Failed to cancel the order", Toast.LENGTH_LONG).show();
                    }
                    startProgess.dismiss();
                } catch (JSONException e) {
                    e.printStackTrace();
...
//                        cancelOrder.setVisibility(View.GONE);
                        if(myTrans.order_fitur.equals("4") || myTrans.order_fitur.equals("3")){
                            textStatus.setText("Status : Delivery to Customers");
                        }else if(myTrans.order_fitur.equals("5")){
                            textStatus.setText("Status : Delivery Items");
                        }else if(myTrans.order_fitur.equals("7")){
                            textStatus.setText("Status : Delivery Items");
                        }else if(myTrans.order_fitur.equals("6") || myTrans.order_fitur.equals("8")){
                            textStatus.setText("Status : Run service");
...
//        Log.d("data_order_finish", dataOrder.toString());
    ...
    private void finishPerjalanan(final JSONObject dataOrder){
        ...
        if(myTrans.order_fitur.equals("3") || myTrans.order_fitur.equals("4")){
            ...
            HTTPHelper.getInstance(activity).finishOrder(dataOrder, new NetworkActionResult() {
                @Override
                public void onSuccess(JSONObject obj) {
                    textStatus.setText("Status : Service Finished");
                    finishProgress.dismiss();
    ...
    private MaterialDialog showWarningCall() {
        final MaterialDialog md = new MaterialDialog.Builder(activity)
                .title("Call")
                .content("You want to call driver?")
                .icon(new IconicsDrawable(activity)
...
//        }else{
    ...
    private void addMarkerToMap(){
        ...
        jakCar = mMap.addMarker(new MarkerOptions()
                .position(NUSAINDAH)
                .title("LOKASI")
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_loc_orange)));
    ...
    public void setMyLocationLayerEnabled() {
        ...
        switch (myTrans.order_fitur){
            case "6":{
                ...
                mMap.addMarker(createMark("LOKASI", start));
