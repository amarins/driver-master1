...
import net.balqisstudio.goeksdriver.activity.NotificationActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static final String BROADCAST_ACTION = "net.balqisstudio.goeksdriver";
...
//                    transaksi.shipper = remMsg.get("shipper");
    ...
    private void intentToChat(Bundle bundle){
        ...
        if(!isForeground("net.balqisstudio.goeksdriver.activity.ChatActivity")){
